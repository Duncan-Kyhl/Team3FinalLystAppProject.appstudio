...
const cacheName = 'LystTeam3FinalLystAppProject-2021-05-03 12:43:31.996002'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'LystTeam3FinalLystAppProject'.length) === 'LystTeam3FinalLystAppProject') {
